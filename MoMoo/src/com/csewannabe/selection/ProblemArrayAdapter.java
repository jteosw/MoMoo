...
public class ProblemArrayAdapter<T> extends ArrayAdapter<T> implements ListAdapter{
	
	Typeface mTypeface;
	
	public ProblemArrayAdapter(Context context, int textViewResourceId, T[] objects) {
		super(context, textViewResourceId, objects);
		mTypeface = Typeface.createFromAsset(context.getAssets(), "fonts/quicksand.ttf");
	}
	
	public ProblemArrayAdapter(Context context, int resource, int textViewResourceId, T[] objects) {
